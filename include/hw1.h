...
void s_cipher(FILE** in,FILE** out, int validargs_return, char** argv_s);
void tut_cipher(FILE** in,FILE** out, int validargs_return,char**  argv_t);
int find_letter(char first_char );
